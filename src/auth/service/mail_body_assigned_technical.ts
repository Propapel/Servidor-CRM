const HTML_TECHNICAL_ASSING_REPORT = (
  userCreatedReport,
  id,
  fecha,
  ubicacion,
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p>Te informamos que tu ticket ha sido asignado a ${nombreTecnico} de nuestro equipo.</p>
      ...
      <p>El técnico se pondrá en contacto contigo en caso de requerir más información o para coordinar la atención del incidente.</p>
...
export default HTML_TECHNICAL_ASSING_REPORT;
