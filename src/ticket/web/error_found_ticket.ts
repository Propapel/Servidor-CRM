const ERROR_FOUND_TICKET = `
     <!DOCTYPE html>
<html xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office" lang="en">

<head>
    <title>Ups error al encontrar ticket</title>
                                                        ...
                                                        <tr>
                                                            <td class="pad" style="width:100%;padding-right:0px;padding-left:0px;">
                                                                <div class="alignment" align="center">
                                                                    <div style="max-width: 225px;"><img src="https://bbecbbde2b.imgdist.com/pub/bfra/zigpwtii/8j0/atv/7ot/c452f2bf-6515-47a7-a811-066c155b5053-removebg-preview%20%281%29.png" style="display: block; height: auto; border: 0; width: 100%;" width="225" alt title height="auto"></div>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div style="color:#fbd711;font-family:'Poppins', Arial, Helvetica, sans-serif;font-size:30px;line-height:1.2;text-align:center;mso-line-height-alt:36px;">
                                                                    <p style="margin: 0; word-break: break-word;"><strong>¡Hmm... este ticket se esfumó! 🕵️‍♂️</strong></p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                        ...
                                                        <tr>
                                                            <td class="pad" style="padding-bottom:10px;padding-left:50px;padding-right:50px;padding-top:10px;">
                                                                <div style="font-family: sans-serif">
                                                                    <div class style="font-size: 12px; font-family: 'Poppins', Arial, Helvetica, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #1a73e8; line-height: 1.2;">
                                                                        <p style="margin: 0; font-size: 12px; text-align: center; mso-line-height-alt: 14.399999999999999px;"><span style="word-break: break-word; font-size: 22px;">No logramos encontrar el ticket que intentas rastrear. ¿Seguro que escribiste bien el número?</span></p>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                        </tr>
...
export default ERROR_FOUND_TICKET;